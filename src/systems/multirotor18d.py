...
class MultirotorTrajEnv(SystemEnv):
    ...
    def reset(self, uav_x=None, modify_wind=False):
        ...
        self.x = np.concatenate((err_wp, vel, ori, rat, err_next_wp, err_next_next_wp), dtype=self.dtype) # TODO: what impacts does err_wp have on the rest of the code?
