...
class MultirotorTrajEnv(SystemEnv):
    ...
    def step(self, u: np.ndarray, **kwargs):
        ...
        for _ in range(self.steps_u):
            ...
            # print("Controller Input", np.concatenate(([self.x[12:15],u])))
            ...
            self.x[18:21] = self.x[0:3] - intersection_point
            ...
            # reward -= np.exp(normal_distance-5) # exponential negative reward for being out of bounds
            # reward -= normal_distance / 5
